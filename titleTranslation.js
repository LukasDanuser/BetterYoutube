        ...
        if (result.titleTranslation === true) {
            ...
            (async() => {
                ...
                */
                ...
                var api_key_awaited = keyResult.api_key;
                if (api_key_awaited === undefined || api_key_awaited === null || api_key_awaited === "" || api_key_awaited === 0) {
                    setValue(prompt("Get a YouTube Data v3 API key from https://console.developers.google.com/apis/library/youtube.googleapis.com?q=YoutubeData"));
                }
                ...
                const API_KEY = keyResult.api_key;
                        ...
                        xhr.onreadystatechange = function() {
                            if (xhr.readyState === 4) { // Success
                                ...
                                if (data.kind == "youtube#videoListResponse") {
                                    ...
                                    if (mainVidID != "") { // Replace Main Video Description
